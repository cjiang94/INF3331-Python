#!/usr/bin/env python
from package.my_integrators.integrator import integrate
from package.my_integrators.integrator import midpoint_integrate as normal_midpoint
from package.my_integrators.numpy_integrator import numpy_integrate
from package.my_integrators.numpy_integrator import midpoint_integrate as numpy_midpoint
from package.my_integrators.numba_integrator import numba_integrate
from package.my_integrators.numba_integrator import midpoint_integrate as numba_midpoint
import time
...
def test_integral_of_exponential_function():
    ...
    assert abs(integrate(integral_of_exponential_function, 0, 1, 1000000) - 1/3) < 1E-5
    assert abs(integrate(integral_of_exponential_function, 0, 1, 5000000) - 1/3) < 1E-5
    print(" - Success - ")
